    ...
    <div class="form--container">
        <div class="container p-0">
            <div class="row d-flex justify-content-center align-items-center">
                <div class="col-md-6 form--body--col d-flex justify-content-center align-items-center flex-column">
                    ...
                    <form action="" method="post" class="w-75">
                        ...
                        <div class="text-left mb-3">
                            <a href="#" class="text--color--secondary form--a--1">Forgot your password?</a>
                        </div>
                        <div class="text-left mb-3">
                        ...
                        <div class="text-left mb-4">
                            <a href="#" class="text-secondary form--a--2">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
